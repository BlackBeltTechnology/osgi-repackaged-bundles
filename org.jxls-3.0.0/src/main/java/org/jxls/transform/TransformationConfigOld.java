...
import org.jxls.util.OsgiJxlsHelper;

/**
 * Transformation configuration class
 */
public class TransformationConfigOld {
    ...
    private ExpressionEvaluator expressionEvaluator =  OsgiJxlsHelper.getInstance().getExpressionEvaluatorFactory().createExpressionEvaluator(null);
